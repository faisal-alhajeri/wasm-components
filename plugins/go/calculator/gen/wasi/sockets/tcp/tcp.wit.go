...
import (
	monotonicclock "components-calculator-go/gen/wasi/clocks/monotonic-clock"
	"components-calculator-go/gen/wasi/io/poll"
	"components-calculator-go/gen/wasi/io/streams"
	"components-calculator-go/gen/wasi/sockets/network"
