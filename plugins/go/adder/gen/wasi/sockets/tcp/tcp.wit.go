...
import (
	monotonicclock "components-adder-go/gen/wasi/clocks/monotonic-clock"
	"components-adder-go/gen/wasi/io/poll"
	"components-adder-go/gen/wasi/io/streams"
	"components-adder-go/gen/wasi/sockets/network"
